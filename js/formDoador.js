function validacaoForm() {
     ...
     if (peso != '') 
     {
          if (periodoGestual != "Não" || amamentacao != "Não" || gripe != "Não" || alcool != "Não" || tatooPiercing != "Não" || InfeSex != "Não" || doencaSangue != "Não" || transfusao != "Não" || extraDente != "Não" || endoscopia != "Não" || malaria != "Não" || hepatite != "Não" || droga != "Não" || peso < 50 || peso > 200)
          {
...
{
     unsucessPopUp.style.display = 'none';
}